...
%define _prefix    /home/johan/taf/opt
%define pkg_prefix 
...
%build
%{expand:%%%cmake_name} . -DCMAKE_BUILD_TYPE= -DCMAKE_PREFIX_PATH:PATH=%{_prefix}  -DENABLE_CURVE25519=1 -DENABLE_CURVE448=1 -DENABLE_C_INTERFACE=1 -DENABLE_JNI=1 -DENABLE_PROFILING=0 -DENABLE_SHARED=1 -DENABLE_STATIC=1 -DENABLE_STRICT=1 -DENABLE_UNIT_TESTS=1
make %{?_smp_mflags}
